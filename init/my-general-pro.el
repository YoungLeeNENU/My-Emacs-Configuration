...
(require 'ascope)
(require 'xcscope+)
(load-file "~/.emacs.d/packages/cscope-15.8a/contrib/xcscope/xcscope.el")
(setq cscope-do-not-update-database t)
(define-key global-map [(meta f1)]      'cscope-set-initial-directory)
(define-key global-map [(meta f2)]	'cscope-unset-initial-directory)
(define-key global-map [(meta f3)]	'cscope-find-global-definition-no-prompting)
(define-key global-map [(meta f4)]	'cscope-next-symbol)
(define-key global-map [(meta f5)]	'cscope-next-file)
(define-key global-map [(meta f6)]	'cscope-prev-symbol)
(define-key global-map [(meta f7)]	'cscope-prev-file)
(define-key global-map [(meta f8)]	'cscope-display-buffer)
(define-key global-map [(meta f9)]	'cscope-display-buffer-toggle)
(define-key global-map [(meta f10)]     'cscope-find-this-symbol-no-prompting-no-updates)
(define-key global-map [(meta f12)]     'cscope-find-global-definition-no-prompting-no-updates)
...
(custom-set-variables
 ...
 '(ecb-key-map (quote ("C-c ." (t "fh" ecb-history-filter)
		       ...
		       (nil "C-c 1" ecb-goto-window-directories)
		       (nil "C-c 2" ecb-goto-window-sources)
		       (nil "C-c 3" ecb-goto-window-methods)
		       (nil "C-c 4" ecb-goto-window-history)
