...
static inline rtx gen_avx_vzeroupper_rex64              (void);
static inline rtx
gen_avx_vzeroupper_rex64(void)
{
  return 0;
}
...
static inline rtx gen_sync_double_compare_and_swap_ccti (rtx, rtx, rtx, rtx, rtx);
static inline rtx
gen_sync_double_compare_and_swap_ccti(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d), rtx ARG_UNUSED (e))
{
  return 0;
}
...
static inline rtx gen_sync_compare_and_swap_ccti        (rtx, rtx, rtx, rtx);
static inline rtx
gen_sync_compare_and_swap_ccti(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
