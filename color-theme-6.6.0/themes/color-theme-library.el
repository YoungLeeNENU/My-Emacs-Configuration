...
(defun color-theme-adom ()
  ...
  (color-theme-install
   '(color-theme-adom
      ...
      (border-color . "#0d1436")
      (cursor-color . "#93010f")
      (foreground-color . "#e7e70d")
      (mouse-color . "black"))
     (fringe ((t (:background "#0d1436"))))
     (mode-line ((t (:foreground "#150679" :background "#8f141d"))))
     (region ((t (:background "#410d63"))))
     (font-lock-builtin-face ((t (:foreground "#1869bf"))))
     (font-lock-comment-face ((t (:foreground "#998c85"))))
     (font-lock-function-name-face ((t (:foreground "#09da01"))))
     (font-lock-keyword-face ((t (:foreground "#d60035"))))
     (font-lock-string-face ((t (:foreground "#ff0fe5"))))
     (font-lock-type-face ((t (:foreground"#0bbcba"))))
     (font-lock-constant-face ((t (:foreground "#109323"))))
     (font-lock-variable-name-face ((t (:foreground "#eb8100"))))
     (minibuffer-prompt ((t (:foreground "#3e6a98" :bold t))))
     (font-lock-warning-face ((t (:foreground "red" :bold t))))
     )))
(provide 'color-theme-adom)

(defun color-theme-moody ()
  (interactive)
  (color-theme-install
   '(color-theme-moody
...
(provide 'color-theme-moody)

(defun color-theme-breathe ()
  (interactive)
  (color-theme-install
   '(color-theme-breathe
      ...
      (foreground-color . "#ffffff")
      (mouse-color . "black"))
     (fringe ((t (:background "#040610"))))
     (mode-line ((t (:foreground "#000000" :background "#73dd08"))))
     (region ((t (:background "#1c4a26"))))
     (font-lock-builtin-face ((t (:foreground "#328cec"))))
     (font-lock-comment-face ((t (:foreground "#03d895"))))
     (font-lock-function-name-face ((t (:foreground "#edd400"))))
     (font-lock-keyword-face ((t (:foreground "#a62ba0"))))
     (font-lock-string-face ((t (:foreground "#ab070c"))))
     (font-lock-type-face ((t (:foreground"#ff6b0a"))))
     (font-lock-constant-face ((t (:foreground "#873612"))))
     (font-lock-variable-name-face ((t (:foreground "#1ce105"))))
     (minibuffer-prompt ((t (:foreground "#297fdb" :bold t))))
